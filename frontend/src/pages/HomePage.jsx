    ...
    <div className="bg-gradient-to-br from-base-100 via-base-200 to-base-300">
      ...
      <nav className="bg-base-100/80 backdrop-blur-md border-b border-primary/20 sticky top-0 z-50 shadow-lg">
        <div className="max-w-7xl mx-auto p-4 flex items-center justify-between">
          ...
          <div className="size-10 rounded-xl bg-gradient-to-br from-primary to-accent via-secondary flex items-center justify-center shadow-lg">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-xl text-base-content/70 leading-relaxed max-w-xl">
              The ultimate platform for collaborative coding interviews and pair programming. Connect face-to-face,
